<%@ page title="SPORT.CGK" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="home, App_Web_tjv0ljbg" %>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel-item">
        ...
        <a class="carousel-control-prev" href="#demo" data-slide="prev" style="position: absolute">
            <span class="carousel-control-prev-icon"></span></a><a class="carousel-control-next"
                href="#demo" data-slide="next" style="position: absolute"><span class="carousel-control-next-icon">
                </span></a>
    </div>
    </div>
            <div style="background-color: #CCCCCC; width: 100%; height: 10%; margin-top: 10px;
                        margin-bottom: 100px; color: #000000;" align="center">
                        Game-
                        ...
                        <asp:Button ID="btnView" runat="server" Text="View" OnClick="btnView_Click" BackColor="#3E7D71"
                            Font-Bold="True" ForeColor="White" Width="100px" /></div>
            <%-- for win loss --%>
            <div>
...
<div id="Div3" class="content-area">
    <div id="Div4" class="site-content" role="main">
                ...
                <div class="entry-content">
                    <div class="vc_row wpb_row vc_row-fluid"><div class="row"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner"><div class="wpb_wrapper"><div class="posts-list-wrapper  latest-results"><div class="list-header"><div class="list-title"><h3>Latest results</h3></div></div><div class="posts-list latest-match-result   latest-results" data-contents-per-item="1" data-width="1024" data-height="1024" data-stagePadding="0" data-margin="0" data-full-width="" data-center="" data-loop="">
<div class="entry latest-match-result post-504 azsc_match type-azsc_match status-publish has-post-thumbnail hentry">
        <div class="entry-data">
        <div class="entry-header">
                                    <h2 class="entry-title"><a href="http://azexo.com/sportak/match/best-of-the-best-match/" rel="bookmark">Best of the best match</a></h2>                                        <div class="entry-meta">
                    <div class="match-date-time"><span class="date"><asp:Label ID="LblDate" runat="server" Text=""></asp:Label></span><%--<span class="time">7:00 </span>--%></div>
                    <div class="match-info"><div class="team1 win">
                    
                    <div class="name"><asp:Label ID="lblWinTName" runat="server" Text=""></asp:Label></div></div><div class="match-score">
                    <div class="score">Score</div>
                    <div class="data team1">
                    <div class="team1 win"><asp:Label ID="lblWinScr" runat="server" Text=""></asp:Label>/<asp:Label ID="LblWinWikt" runat="server" Text=""></asp:Label></div>
                    <div class="vs">VS</div>
                    <div class="team2 loss"><asp:Label ID="lblLossScr" runat="server" Text=""></asp:Label>/<asp:Label ID="LblLossWikt" runat="server" Text=""></asp:Label></div></div></div>
                    <div class="team2 loss">
                    
                    <div class="name"><asp:Label ID="lblLossTName" runat="server" Text=""></asp:Label></div></div></div>                </div>
                                </div>


                                    <div class="entry-summary">
                    See The Match Result... &hellip;                </div><!-- .entry-summary -->
                    
                <div class="entry-footer">
            <div class="entry-more"> <asp:Button ID="btnMR" runat="server" Text="Match Detail" 
                    onclick="btnMR_Click"></asp:Button></div>        </div>
            </div>    
</div><!-- #post -->
    ...
    <div class="row align-items-center justify-content-xl-between">
      <div class="col-xl-6 m-auto text-center">
        <div class="copyright"><p>Create by Hemant D</p>
        </div>
      </div>
    </div>
  </footer>
