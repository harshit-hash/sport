<%@ page title="SPORT.CGK" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="cri_detail, App_Web_4l4w3xsn" %>
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item" style="padding: 100px">
          ...
          <div class="col-sm-8 col-lg-8 col-md-8 col-xl-8" style="background-color: #FFC723; width: 100%; height: 100%;color: #000000;">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/image/volleyball-with-net-1.jpg" Width="80%" 
...
<div class="row" style="background-color: #38736B; padding-bottom: 0px; height :250px" >
  <div class="columnn">
    <img src="image/volleyball-with-net-1.jpg" alt="Nature" style="width:100%" 
          onclick="myFunction(this);">
  </div>
  <div class="columnn">
    <img src="image/tvb.jpg" alt="Snow" style="width:100%" 
          onclick="myFunction(this);">
  </div>
  <div class="columnn">
    <img src="image/m_blog-common-volleyball-injuries-8-17_optimized.jpg" alt="Mountains" style="width:100%" 
          onclick="myFunction(this);">
  </div>
  <div class="columnn">
