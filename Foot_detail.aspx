<%@ page title="SPORT.CGK" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="cri_detail, App_Web_5i3zjyyk" %>
        ...
        <li class="nav-item" style="padding: 100px">
          <a class="nav-link active" href="AllTournament.aspx" >Tournament Detail</a>
           ...
           <div class="col-sm-8 col-lg-8 col-md-8 col-xl-8" style="background-color: #FFC723; width: 100%; height: 100%;color: #000000;">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/image/football.jpg" Width="80%" 
...
<div class="row" style="background-color: #38736B; padding-bottom: 0px; height :250px" >
  <div class="columnn">
    <img src="image/tfb.jpg" alt="Nature" style="width:100%" 
  ...
  <div class="columnn">
    <img src="image/football1.jpg" alt="Mountains" style="width:100%" 
          onclick="myFunction(this);">
  </div>
  <div class="columnn">
