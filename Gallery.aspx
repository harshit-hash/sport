<%@ page title="SPORT.CGK" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Gallery, App_Web_4l4w3xsn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            </asp:ScriptManager> <div style="padding-top:100px">
                                            ...
                                            <div class="vc_column-inner">
                                                <div class="wpb_wrapper">
                                                    ...
                                                    <div class="filters-wrapper ">
                                                        ...
                                                        <script type="text/javascript">                                                            window["filters-44283495"] = { "0": { "items": "1" }, "786": { "items": "2" }, "962": { "items": "3" }, "1200": { "items": "4"} };</script>
                                                        <div class="filterable masonry" data-selector=".entry" data-responsive="filters-44283495"
                                                            data-gutter="0">
                                                      
                                                            <div class="entry  gallery-item badminton">
                                                            
                                                                <div class="entry-thumbnail">
                                                                <div class="image" style="background-image: url('image/tbtn.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                   <%-- <div class="entry-header">
                                                                    ...
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/tbtn.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                            <!-- entry -->
                                                            <div class="entry  gallery-item football">
                                                                <div class="entry-thumbnail">
                                                                <div class="image" style="background-image: url('image/football.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                   <%-- <div class="entry-header">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/football.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                            ...
                                                            <div class="entry  gallery-item football">
                                                                <div class="entry-thumbnail">
                                                                    <div class="image" style="background-image: url('image/football1.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                   <%-- <div class="entry-header">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/football1.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                            ...
                                                            <div class="entry  gallery-item football">
                                                                <div class="entry-thumbnail">
                                                                    <div class="image" style="background-image: url('image/tfb.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                   <%-- <div class="entry-header">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/tfb.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                            <!-- entry -->
                                                            <div class="entry  gallery-item cricket">
                                                                <div class="entry-thumbnail">
                                                                    <div class="image" style="background-image: url('image/cricket stadium.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/cricket stadium.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                             <div class="entry  gallery-item cricket">
                                                                <div class="entry-thumbnail">
                                                                    <div class="image" style="background-image: url('image/cricket.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/cricket.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                             <div class="entry  gallery-item volleyball">
                                                                <div class="entry-thumbnail">
                                                                    <div class="image" style="background-image: url('image/volleyball-with-net-1.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/volleyball-with-net-1.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
                                                           <div class="entry  gallery-item cricket">
                                                                <div class="entry-thumbnail">
                                                                    <div class="image" style="background-image: url('image/m_blog-common-volleyball-injuries-8-17_optimized.jpg');
                                                                        height: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="entry-data">
                                                                    ...
                                                                    <!-- header -->
                                                                    <div class="entry-footer">
                                                                        <a class="image-popup" href="image/m_blog-common-volleyball-injuries-8-17_optimized.jpg">
                                                                            -</a></div>
                                                                </div>
                                                                <!-- data -->
                                                            </div>
